...
class EncryptedPersonalDataBinaryHandlingTest {
    ...
    void shouldHandleRandomBinaryDataSafely() {
        ...
        byte[] randomIv = new byte[]{(byte) 0x80, (byte) 0x81, (byte) 0x82, (byte) 0x83, 
    ...
    void shouldHandleEncryptedDataConversionCorrectly() {
        ...
        JsonPersonalDataFieldDefinition<Object> fieldDefinition = 
            new JsonPersonalDataFieldDefinition<>("testField", null);
        
        // Use reflection to access private method for testing
        try {
            var method = JsonPersonalDataFieldDefinition.class
                .getDeclaredMethod("toEncryptedPersonalDataJson", String.class, EncryptedData.class);
            ...
            var toEncryptedDataMethod = JsonPersonalDataFieldDefinition.class
                .getDeclaredMethod("toEncryptedData", EncryptedPersonalData.class);
