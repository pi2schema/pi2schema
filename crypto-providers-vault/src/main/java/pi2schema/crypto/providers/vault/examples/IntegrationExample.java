...
public class IntegrationExample {
    ...
    public static class UserService {
        ...
        public CompletableFuture<Void> storeUserData(String userId, UserData userData) {
            return encryptingProvider.encryptionKeysFor(userId)
                .thenApply(material -> {
                    try {
        ...
        public CompletableFuture<UserData> getUserData(String userId) {
            ...
            return decryptingProvider.decryptionKeysFor(
                userId, 
        ...
        public CompletableFuture<Void> deleteUserData(String userId) {
            return CompletableFuture.runAsync(() -> {
                ...
                System.out.println("Note: In production, also delete Vault key: " + 
                    generateKeyName(userId));
            });
        }
    ...
    public static class UserData {
        ...
        public String toString() {
            return String.format("UserData{name='%s', email='%s', phone='%s', address='%s'}", 
    ...
    public static class EncryptedUserRecord {
        ...
        public EncryptedUserRecord(String userId, byte[] encryptedData, 
                                 byte[] encryptedDataKey, String encryptionContext, long timestamp) {
            this.userId = userId;
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (UserService userService = new UserService(config)) {
