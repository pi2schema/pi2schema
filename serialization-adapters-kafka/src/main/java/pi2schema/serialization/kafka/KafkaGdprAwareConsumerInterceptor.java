...
public final class KafkaGdprAwareConsumerInterceptor<K, V extends SpecificRecordBase> implements ConsumerInterceptor<K, V> {
    ...
    public KafkaGdprAwareConsumerInterceptor(AvroDecryptionEngine<V> decryptionEngine, DecryptingMaterialsProvider materialsProvider) {
