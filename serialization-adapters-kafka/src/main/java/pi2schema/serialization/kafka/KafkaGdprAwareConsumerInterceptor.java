...
public final class KafkaGdprAwareConsumerInterceptor<K, V>
                    ...
                    var decrypted = records
                            ...
                            .map(record ->
                                    new ConsumerRecord<>(
                                            ...
                                            record.key(),
                                            provider.forType(record.value())
                                                    .swapToDecrypted(decryptor, record.value()),
                                            record.headers(),
                                            record.leaderEpoch()
                                    )
                            )
    ...
    public void configure(Map<String, ?> configs) {
        ...
        provider = new PiiAwareInterceptorConfig(configs)
