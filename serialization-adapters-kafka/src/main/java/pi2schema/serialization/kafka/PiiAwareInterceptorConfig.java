...
public class PiiAwareInterceptorConfig extends AbstractConfig {
    ...
    public static final String PERSONAL_METADATA_PROVIDER_CONFIG_DOC = "The Personal metadata provider capable of ispect the ";
    // TODO: improve documentation, describe currently supported classes.

    static {
        CONFIG = new ConfigDef().define(PERSONAL_METADATA_PROVIDER_CONFIG,
